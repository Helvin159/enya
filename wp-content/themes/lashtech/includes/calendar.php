                        ...
                        <div  class="col-md-2 py-4 days 
                            ...
                            <div id="<?php echo $count; ?>" class="container day  <?php if($count < date('j')){ echo ' ';}else{ echo 'openTime '; }; if($count == date('j')){ echo 'todayFont'; } ?>   ">
                                ...
                                <div class="agenda  text-center">
                                    <input id="dayInput" type="hidden" value="<?php echo $count;?>">
                                    <input id="name" class="inputFields" type="text" name="name" placeholder="Anne Doe"> 
                                    <input id="phone" class="inputFields" type="tel" name="phoneNumber" placeholder="(978)888-8888">  
                                    <input id="email" class="inputFields" type="email" name="email" placeholder="Email"> 
                                    <input id="time" class="inputFields" type="time" name="time" >
