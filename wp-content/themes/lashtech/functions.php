...
function lash_files (){
  ...
  if(strstr($_SERVER['SERVER_NAME'], 'enya.local')){
    ...
    wp_enqueue_style('my-style', get_theme_file_uri('/css/styles.css'), null, '1.0', 'all');
      ...
      // CSS
    //   wp_enqueue_style('my-style', get_theme_file_uri('/css/styles.css'), null, '1.0', 'all');
      wp_enqueue_style('my-style', get_theme_file_uri('/bundled-assets/styles.d080dac5abc7b285cb7d.css'), null, '1.0', 'all');
      wp_enqueue_script('our-vendors-js', get_theme_file_uri('/bundled-assets/undefined'), NULL, '1.0', true);
      wp_enqueue_script('main-lash-scripts', get_theme_file_uri('/bundled-assets/scripts.d080dac5abc7b285cb7d.js'), NULL, '1.0', true);
    }
